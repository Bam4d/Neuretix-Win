...
group* GAEngine::CreateRandomCluster(int maxNeurons,int id)
{
    ...
    _RGB _randCol; //set of random colours
    _randCol.r = 1;
    _randCol.g = 0;
    _randCol.b = 0;
...
ClusterMap GAEngine::DuplicateClusterMap(ClusterMap * _toDuplicate)
{
    ...
    UuidCopy(&_newClusterMap.UUID_inst,&_toDuplicate->UUID_inst);
...
{
    ClusterMapLink _newLink = ClusterMapLink(dest->UUID_inst,src->UUID_inst);
