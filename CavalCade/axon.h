...
public:
	...
	void  (*externalmethod)(void); //points to the external method to be called on neuron fire
	int isFiring;
	...
	void AcceptFire(); //function is run when source neuron fires
